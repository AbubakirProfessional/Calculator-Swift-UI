...
//  CalculatorUI
//
//  Created by Shreyas Roziboyev Abubakir on 10/09/22.
...
extension Color {
    static let darkStart = Color(red: 60 / 255, green: 60 / 255, blue: 80 / 255)
    static let darkEnd = Color(red: 18 / 255, green: 15 / 255, blue: 35 / 255)
        ...
        ZStack {
            ...
            VStack {
                ...
                RoundedRectangle(cornerRadius: 15)
                        ...
                        .overlay {
                            RoundedRectangle(cornerRadius: 15).stroke(.white, lineWidth: 5)
                                   }
